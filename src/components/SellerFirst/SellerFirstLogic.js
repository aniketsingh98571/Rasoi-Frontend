...
const SellerFirstLogic=()=>{
    ...
    return {response,ModalOpen,FirstForm,SecondForm,FirstFormHandler,SecondFormHandler,FoodPicHandler,ProfilePicHandler,NavigateNext,OuterForm,InnerForm,DoneHandler,StopNavigation,setResponse}
}
