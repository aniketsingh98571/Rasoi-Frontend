                        ...
                        return (
                                ...
                                </div>
                                {
                                    ele.dishes.map((ele2)=>{
                                        return(
                                            ...
                                            <p>{ele2.dishName} x {ele2.dishQty}</p>
                                           </div>
                                        )
                                    })
                                }
                            ...
                            <div className={classes.PartThreeContainer}>
                                <div className={classes.StatusContainer}>
                                    <p><span>Status</span>:- {ele.orderStatus}</p>
                                </div>
                                {
                                    ele.isRated===false&&ele.orderStatus==="Delivered"?
                                <div className={classes.SellerRatingContainer}>
                                    <button type="button" onClick={()=>RateSeller(ele.orderID,ele.sellerID)}>Rate the Seller</button>
                                </div>:null
                    }
